...
import ray
import torch
from utils import set_gpus, parse_config, create_result_folder, \
...
parser.add_argument('--config_file', type=str, default='CONFIGS/smnist_28/smnist_slda.yaml', help='path to yaml configuration file')
